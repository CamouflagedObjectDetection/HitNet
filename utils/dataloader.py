...
class CODataset(data.Dataset):
    ...
    def __init__(self, image_root, gt_root, trainsize, augmentations):
        ...
        self.gts = [gt_root + f for f in os.listdir(gt_root) if f.endswith('.png') and '-CAM-' in f]
        #
...
class test_dataset:
    def __init__(self, image_root, gt_root, testsize):
        ...
        self.images = [image_root + f for f in os.listdir(image_root) if (f.endswith('.jpg') or f.endswith('.png')) and '-CAM-' in f]
        self.gts = [gt_root + f for f in os.listdir(gt_root) if (f.endswith('.tif') or f.endswith('.png')) and '-CAM-' in f]
        self.images = sorted(self.images)
        self.gts = sorted(self.gts)
